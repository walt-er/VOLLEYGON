...
{
	public class ValuePopupAttribute : PropertyAttribute
	{
	    public string[] list;
	    public object variableType;

		#region ValuePopupAttribute()
		...
		public ValuePopupAttribute(params object[] list)
	    {
	    ...
	    private bool IsVariablesTypeConsistent(object[] list)
	    {
	        for (int i = 0; i < list.Length; i++)
	        {
	            ...
	            else if ((System.Type)variableType != list[i].GetType())
	            {
